...
MESH_DIR = '/share/WHAM_Results_NEW'
EXCLUDE_PATH = osp.join(os.path.dirname(os.path.abspath(__file__)), "sample_txts", "class_6.txt")
		...
		for task in sorted(os.listdir(huanz_folder)):
			if "LimbAction_1" in task:
				...
				if osp.exists(wham_file):
					...
					results[huanz] = smploutput.joints
					num += 1
